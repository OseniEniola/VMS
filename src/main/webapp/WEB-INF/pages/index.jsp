...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background: #c850c0;
...
">
		...
		<div class="gtco-container">
			...
			<c:if test="${param.act == 'reg'}">
				<p class="success">Employee Registered Successfully!</p>
			</c:if>
			</div>
									...
									<f:form action="${url_login }"  modelAttribute="login">
